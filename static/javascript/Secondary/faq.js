...
let listaPreguntasMapa = document.getElementById("listaPreguntasMapa")
let listaPreguntasRegistro = document.getElementById("listaPreguntasRegistro")
let listaPreguntasPrivacidad = document.getElementById("listaPreguntasPrivacidad")
let listaPreguntasPremium = document.getElementById("listaPreguntasPremium")


let objetoIds = {
    mapa: listaPreguntasMapa,
    registro: listaPreguntasRegistro,
    privacidad: listaPreguntasPrivacidad,
    premium: listaPreguntasPremium,
}

let categoriaTrabajar = objetoIds.mapa

for(let categoria of Object.keys(objetoPreguntas)) {
    console.log(categoria)
    categoriaTrabajar = objetoIds[categoria]
    objetoPreguntas[categoria].forEach((objetoConPregunta) => {
